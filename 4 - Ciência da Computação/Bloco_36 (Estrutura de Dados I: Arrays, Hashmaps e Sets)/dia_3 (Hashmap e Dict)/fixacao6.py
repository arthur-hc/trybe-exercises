# Exercício 6: Dada uma string, construa um dicionário com a contagem de
# cada caractere da palavra. Utilize o pseudocódigo e o exemplo abaixo para
# se nortear.
...
def repeated_counter(string):
    return dict(Counter(string))


print(repeated_counter("coxinha"))
