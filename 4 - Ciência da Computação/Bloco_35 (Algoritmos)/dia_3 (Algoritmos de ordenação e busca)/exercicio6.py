...
# precisamos voltar no tempo verificando os commits antigos, de modo a
# descobrir um commit em que os testes falham. Supondo que isto será
# representado como um array de booleanos , descubra o índice onde o erro
